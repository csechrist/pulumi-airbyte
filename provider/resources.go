...
import (
	...
	airbyte "github.com/airbytehq/terraform-provider-airbyte/shim"

	"github.com/csechrist/pulumi-airbyte/provider/pkg/version"
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Keywords:   []string{"pulumi", "airbyte", "category/cloud"},
		License:    "Apache-2.0",
