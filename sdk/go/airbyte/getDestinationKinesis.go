...
// The values required to configure the destination. Parsed as JSON.
func (o LookupDestinationKinesisResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationKinesisResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupDestinationKinesisResultOutput) DestinationType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationKinesisResult) string { return v.DestinationType }).(pulumi.StringOutput)
}
