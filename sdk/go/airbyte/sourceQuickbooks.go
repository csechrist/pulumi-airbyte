...
// The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires replacement if changed.
func (o SourceQuickbooksOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SourceQuickbooks) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
