...
// The values required to configure the destination. Parsed as JSON.
func (o LookupDestinationVerticaResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationVerticaResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupDestinationVerticaResultOutput) DestinationType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationVerticaResult) string { return v.DestinationType }).(pulumi.StringOutput)
}
