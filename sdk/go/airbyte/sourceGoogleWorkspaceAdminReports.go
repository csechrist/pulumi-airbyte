...
// The UUID of the connector definition. One of configuration.sourceType or definitionId must be provided. Requires replacement if changed.
func (o SourceGoogleWorkspaceAdminReportsOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SourceGoogleWorkspaceAdminReports) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
