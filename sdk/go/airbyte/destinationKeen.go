...
// The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires replacement if changed.
func (o DestinationKeenOutput) DefinitionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *DestinationKeen) pulumi.StringPtrOutput { return v.DefinitionId }).(pulumi.StringPtrOutput)
}
