...
// The values required to configure the destination. Parsed as JSON.
func (o LookupDestinationFireboltResultOutput) Configuration() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationFireboltResult) string { return v.Configuration }).(pulumi.StringOutput)
}
...
func (o LookupDestinationFireboltResultOutput) DestinationType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupDestinationFireboltResult) string { return v.DestinationType }).(pulumi.StringOutput)
}
