...
//			_, err := airbyte.NewDestinationLangchain(ctx, "myDestinationLangchain", &airbyte.DestinationLangchainArgs{
//				Configuration: &airbyte.DestinationLangchainConfigurationArgs{
//					Embedding: &airbyte.DestinationLangchainConfigurationEmbeddingArgs{
//						Fake: nil,
//					},
//					Indexing: &airbyte.DestinationLangchainConfigurationIndexingArgs{
//						ChromaLocalPersistance: &airbyte.DestinationLangchainConfigurationIndexingChromaLocalPersistanceArgs{
//							CollectionName:  pulumi.String("...my_collection_name..."),
//							DestinationPath: pulumi.String("/local/my_chroma_db"),
//						},
//					},
//					Processing: &airbyte.DestinationLangchainConfigurationProcessingArgs{
//						ChunkOverlap: pulumi.Int(1),
//						ChunkSize:    pulumi.Int(5),
//						TextFields: pulumi.StringArray{
//							pulumi.String("..."),
//						},
//					},
//				},
//				DefinitionId: pulumi.String("2d15ef4e-895c-4921-a618-452d1432f338"),
//				WorkspaceId:  pulumi.String("4ca4c8c4-bf88-4272-9c3c-6bc39a6d3f39"),
//			})
//			if err != nil {
//				return err
//			}
