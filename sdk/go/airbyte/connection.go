...
//			_, err := airbyte.NewConnection(ctx, "myConnection", &airbyte.ConnectionArgs{
//				DataResidency:                    pulumi.String("eu"),
//				DestinationId:                    pulumi.String("669dd1e3-6208-43ea-bc85-5914e0a570f6"),
//				NamespaceDefinition:              pulumi.String("custom_format"),
//				NamespaceFormat:                  pulumi.Any(SOURCE_NAMESPACE),
//				NonBreakingSchemaUpdatesBehavior: pulumi.String("propagate_columns"),
//				Prefix:                           pulumi.String("...my_prefix..."),
//				SourceId:                         pulumi.String("3a555847-8358-4423-a5b6-c7b3fd2fd307"),
...
type Connection struct {
	...
	// Define the location where the data will be stored in the destination. must be one of ["source", "destination", "customFormat"]; Default: "destination"
	...
	// Set how Airbyte handles syncs when it detects a non-breaking schema change in the source. must be one of ["ignore", "disable*connection", "propagate*columns", "propagateFully"]; Default: "ignore"
