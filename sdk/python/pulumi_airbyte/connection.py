...
class ConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] namespace_definition: Define the location where the data will be stored in the destination. must be one of ["source", "destination", "custom_format"]; Default: "destination"
        :param pulumi.Input[str] namespace_format: Used when namespaceDefinition is 'custom*format'. If blank then behaves like namespaceDefinition = 'destination'. If "${SOURCE*NAMESPACE}" then behaves like namespaceDefinition = 'source'. Default: null
        :param pulumi.Input[str] non_breaking_schema_updates_behavior: Set how Airbyte handles syncs when it detects a non-breaking schema change in the source. must be one of ["ignore", "disable*connection", "propagate*columns", "propagate_fully"]; Default: "ignore"
...
class Connection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        my_connection = airbyte.Connection("myConnection",
            data_residency="eu",
