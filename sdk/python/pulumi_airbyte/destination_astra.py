...
class DestinationAstraArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DestinationAstraConfigurationArgs'] configuration: The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination configuration,
...
class DestinationAstra(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['DestinationAstraConfigurationArgs']] configuration: The configuration model for the Vector DB based destinations. This model is used to generate the UI for the destination configuration,
               as well as to provide type safety for the configuration passed to the destination.
        :param pulumi.Input[str] definition_id: The UUID of the connector definition. One of configuration.destinationType or definitionId must be provided. Requires
               replacement if changed.
        :param pulumi.Input[str] name: Name of the destination e.g. dev-mysql-instance.
