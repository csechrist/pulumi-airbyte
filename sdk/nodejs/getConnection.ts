...
export interface GetConnectionResult {
    ...
    /**
     * Define the location where the data will be stored in the destination. must be one of ["source", "destination", "customFormat"]
     */
    readonly namespaceDefinition: string;
    readonly namespaceFormat: string;
    /**
     * Set how Airbyte handles syncs when it detects a non-breaking schema change in the source. must be one of ["ignore", "disable*connection", "propagate*columns", "propagateFully"]
     */
