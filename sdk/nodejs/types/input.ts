...
export interface DestinationRedshiftConfiguration {
     ...
     */
    enableIncrementalFinalTableUpdates?: pulumi.Input<boolean>;
    /**
...
export interface DestinationVerticaConfigurationTunnelMethod {
    noTunnel?: pulumi.Input<inputs.DestinationVerticaConfigurationTunnelMethodNoTunnel>;
    passwordAuthentication?: pulumi.Input<inputs.DestinationVerticaConfigurationTunnelMethodPasswordAuthentication>;
    sshKeyAuthentication?: pulumi.Input<inputs.DestinationVerticaConfigurationTunnelMethodSshKeyAuthentication>;
}

export interface DestinationVerticaConfigurationTunnelMethodNoTunnel {
}

export interface DestinationVerticaConfigurationTunnelMethodPasswordAuthentication {
    /**
     * Hostname of the jump server host that allows inbound ssh tunnel.
     */
    tunnelHost: pulumi.Input<string>;
...
export interface DestinationVerticaConfigurationTunnelMethodSshKeyAuthentication {
    /**
     * OS-level user account ssh key credentials in RSA PEM format ( created with ssh-keygen -t rsa -m PEM -f myuserRsa )
     */
    sshKey: pulumi.Input<string>;
...
export interface SourceAmplitudeConfiguration {
    ...
    /**
     * According to \n\nConsiderations\n\n too big time range in request can cause a timeout error. In this case, set shorter time interval in hours. Default: 24
     */
...
export interface SourceFakerConfiguration {
    ...
    /**
     * How many users should be generated in total.  This setting does not apply to the purchases or products stream. Default: 1000
     */
...
export interface SourceGcsConfigurationStreamFormatCsvFormat {
    ...
    skipRowsBeforeHeader?: pulumi.Input<number>;
    /**
     * Whether strings can be interpreted as null values. If true, strings that match the null*values set will be interpreted as null. If false, strings that match the null*values set will be interpreted as the string itself. Default: true
     */
    stringsCanBeNull?: pulumi.Input<boolean>;
    /**
     * A set of case-sensitive strings that should be interpreted as true values.
...
export interface SourceMysqlConfigurationSslModeVerifyCa {
    ...
    caCertificate: pulumi.Input<string>;
    /**
     * Client certificate (this is not a required field, but if you want to use it, you will need to add the \n\nClient key\n\n as well)
     */
    clientCertificate?: pulumi.Input<string>;
    /**
     * Client key (this is not a required field, but if you want to use it, you will need to add the \n\nClient certificate\n\n as well)
     */
    clientKey?: pulumi.Input<string>;
    /**
     * Password for keystorage. This field is optional. If you do not add it - the password will be generated automatically.
...
export interface SourceQuickbooksConfigurationCredentials {
    oAuth20?: pulumi.Input<inputs.SourceQuickbooksConfigurationCredentialsOAuth20>;
}

export interface SourceQuickbooksConfigurationCredentialsOAuth20 {
    /**
...
export interface SourceS3Configuration {
    ...
    /**
     * Deprecated and will be removed soon. Please do not use this field anymore and use streams.globs instead. A regular expression which tells the connector which files to replicate. All files which match this pattern will be replicated. Use | to separate multiple patterns. See \n\nthis page\n\n to understand pattern syntax (GLOBSTAR and SPLIT flags are enabled). Use pattern \n\n**\n\n to pick up all files.
     */
    pathPattern?: pulumi.Input<string>;
    /**
     * Deprecated and will be removed soon. Please do not use this field anymore and use bucket, aws*access*key*id, aws*secret*access*key and endpoint instead. Use this to load files from S3 or S3-compatible services
     */
...
export interface SourceS3ConfigurationFormatJsonl {
    ...
    newlinesInValues?: pulumi.Input<boolean>;
    /**
     * How JSON fields outside of explicit*schema (if given) are treated. Check  href="https://arrow.apache.org/docs/python/generated/pyarrow.json.ParseOptions.html" target="*blank">PyArrow documentation\n\n for details. must be one of ["ignore", "infer", "error"]; Default: "infer"
     */
...
export interface SourceStripeConfiguration {
    ...
    lookbackWindowDays?: pulumi.Input<number>;
    /**
     * The number of worker thread to use for the sync. The performance upper boundary depends on call*rate*limit setting and type of account. Default: 10
     */
